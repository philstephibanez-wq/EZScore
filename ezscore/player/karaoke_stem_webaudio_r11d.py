...
"""R11d karaoke presentation layer.
...
_COMPONENT_R11D = st.components.v2.component(
    "ezscore_karaoke_stem_player_r11d",
    html=_HTML,
    css=_CSS,
    js=_JS,
    isolate_styles=True,
...
def _component_with_r11d_data(*, data: dict[str, Any], **kwargs):
    ...
    return _COMPONENT_R11D(data=payload, **kwargs)


_base._COMPONENT = _component_with_r11d_data
