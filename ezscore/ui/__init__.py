...
R12 keeps the R10 audio engine and fixes only conductor presentation.
"""

def _install_karaoke_patch() -> None:
    try:
        from ezscore.ui import stem_lab_analysis as _stem_lab
        from ezscore.player.karaoke_stem_webaudio_r12 import (
        ...
        try:
            ...
            st.error(f"Lecteur karaoké R12 indisponible : {exc}")
        except Exception:
            pass
