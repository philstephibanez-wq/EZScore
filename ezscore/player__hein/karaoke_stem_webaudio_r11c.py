...
"""R11c karaoke presentation layer.
...
_COMPONENT_R11C = st.components.v2.component(
    "ezscore_karaoke_stem_player_r11c",
    html=_HTML,
    css=_CSS,
    js=_JS,
    isolate_styles=True,
...
def _component_with_r11c_data(*, data: dict[str, Any], **kwargs):
    ...
    return _COMPONENT_R11C(data=payload, **kwargs)


_base._COMPONENT = _component_with_r11c_data
