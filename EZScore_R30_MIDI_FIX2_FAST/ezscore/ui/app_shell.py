...
# ---------------------------------------------------------------------------
# R30 MIDI symbol bridge — narrow and one-shot.
#
# EZScore.py later executes:
#     from ezscore.persistence import *
#
# We expose build_midi_file only through that explicit export list so the
# existing monolithic caller receives the missing symbol. No builtins mutation,
# no per-rerun MIDI generation outside the Analyse view.
# ---------------------------------------------------------------------------
